...
class Transformer(nn.Module):
    ...
    def __init__(self, d_model=1024, nhead=8, num_encoder_layers=2,
...
q = torch.randn(size=(1024, 4, 256))
k = torch.randn(size=(2048, 4, 256))
v = torch.randn(size=(2024, 4, 256))
mask = torch.randn(size=(4, 524288))
r = tr(q, k, v, mask)
print(r.shape)
